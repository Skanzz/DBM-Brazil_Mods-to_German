module.exports = {
    name: "Add Member Role NEW MOD",
    section: "Member Control",
    meta: {
      version: '2.1.7',
      preciseCheck: true,
      author: 'Translated by Skanz',
    ...
    html(isEvent, data) {
      return `
      <div class="dbmmodsbr1 xinelaslink" data-url="https://github.com/DBM-Mods/Portugues/archive/refs/heads/main.zip">Aktualisieren</div>
      <div class="dbmmodsbr2 xinelaslink" data-url="https://github.com/DBM-Mods/Portugues">Version 0.2</div>
      <div style="width: 100%; padding:1px 5px;height: calc(100vh - 160px);overflow:auto">
      <tab-system style="margin-top: 5px;">
      <tab label="Aktion" icon="align left">
      <div style="padding: 8px;height: calc(100vh - 210px);overflow-y: auto;overflow-x: hidden;width:100%">
      
  <role-input dropdownLabel="Variable" selectId="role" variableContainerId="varNameContainer" variableInputId="varName"></role-input>
  <br><br><br>
  ...
  <div style="padding-top: 8px;">
    <span class="dbminputlabel">Grund</span>
  ...
  <td><span class="dbminputlabel">Aktionsbeschreibung</span><br><input type="text" class="round" id="description" placeholder="Zum Entfernen leer lassen"></td>
  <td style="padding:0px 0px 0px 10px;width:70px"><div style="float:left;padding:0px 0px 0px 7px;margin-top:-5px"><dbm-checkbox id="descriptionx" label="Cor"></dbm-checkbox></div><br><input type="color" value="#ffffff" class="round" id="descriptioncolor"></td>
  </tr></table>
  </div>
  <br>
  <span class="dbminputlabel">Optionen</span><br><div style="padding:10px;background:rgba(0,0,0,0.4)">
  <dbm-checkbox id="errcmd" label="Fehler in der Console anzeigen lassen" checked></dbm-checkbox>
  </div>
  <div>
  <br>
  <table>
    <tr>
    <td class="col1"><span class="dbminputlabel">Fehlermeldung ein</span><br>
    <select id="errs" value="0" class="round" onchange="glob.variableChange(this, 'varNameContainer2')">
      ${data.variables[0]}
    </select></td>
    <td class="col2"><div id="varNameContainer2"><span class="dbminputlabel">Variablennamen</span><br>
  ...
  <span class="dbminputlabel">Wenn aktion Fehl schlägt</span><br>
  <select id="iffalse" class="round" onchange="glob.onComparisonChanged(this)">
  <option value="0" selected>Aktionen fortsetzen</option>
  <option value="1">Aktionssequenz stoppen</option>
  <option value="2">zur Action gehen</option>
  <option value="3">Nächste Aktionen überspringen</option>
  <option value="4">Gehe zur Aktion</option>
  <option value="5">Aktionen ausführen und stoppen</option>
  <option value="6">Handeln Sie und fahren Sie fort</option>
  </select>
  <br>
  </div>
  ...
  `;
    ...
    init: function () {
      ...
      glob.onComparisonChanged = function (event) {
        ...
        if (event.value == "2") {
          document.querySelector("[id='xinelas']").innerText = (`Aktiennummer`);
        }
        if (event.value == "3") {
          document.querySelector("[id='xinelas']").innerText = (`Aktionen überspringen`);
        }
        if (event.value == "4") {
          document.querySelector("[id='xinelas']").innerText = (`Aktionsname`);
        }
      }
